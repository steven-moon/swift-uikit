...
public struct ModelCardView: View {
  public struct ModelInfo: Identifiable {
    ...
    public init(
      ...
      quantization: String? = nil, imageURL: URL? = nil, isDownloaded: Bool = false,
      isDownloading: Bool = false, downloadProgress: Double? = nil, statusMessage: String? = nil,
      statusColor: Color? = nil, architecture: String? = nil
    ) {
      self.id = id
      self.name = name
  ...
  public init(
    model: ModelInfo, onDownload: (() -> Void)? = nil, onDelete: (() -> Void)? = nil,
