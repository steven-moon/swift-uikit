...
public struct GlassmorphicStyle: UIAIStyle {
  ...
  public var shadow: ShadowStyle? {
    ShadowStyle(color: .black.opacity(0.1), radius: 12, x: 0, y: 2)
  }
...
public struct DarkStyle: UIAIStyle {
  ...
  public var cornerRadius: CGFloat { 12 }
  public var shadow: ShadowStyle? {
    ShadowStyle(color: .black.opacity(0.5), radius: 10, x: 0, y: 4)
  }
...
public struct VibrantStyle: UIAIStyle {
  ...
  public var shadow: ShadowStyle? {
    ShadowStyle(color: .orange.opacity(0.3), radius: 14, x: 0, y: 6)
  }
...
public struct BrandXStyle: UIAIStyle {
  ...
  public var cornerRadius: CGFloat { 18 }
  public var shadow: ShadowStyle? {
    ShadowStyle(color: .orange.opacity(0.2), radius: 10, x: 2, y: 4)
  }
...
extension EnvironmentValues {
  ...
  public var uiaiStyle: any UIAIStyle {
...
extension View {
  ...
  public func uiaiStyle(_ style: any UIAIStyle) -> some View {
